...

    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "Insert Into customer(A_Id,C_Name,A_title,A_type,Gender,Dob,Nationality,P_Add,Phone,Nic,Email,Occup,Init_dep) Values('" + account_number + "','" + customer_name + "','" + account_titel + "','" + account_type + "','" + gender + "','" + dob + "','" + nationality + "','" + postal_address + "','" + phone_number + "','" + nic_number + "','" + email + "','" + occupation + "','" + initial_deposit + "')";
                Execute(query);
                clear();
